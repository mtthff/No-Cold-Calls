...
// open the database - if database exists, then opens the existing one, else opens a new one.
    ...
    $stmt = $DBH->prepare("INSERT INTO appointment (status_id, customer_id, datetime, contact, phone, mobil, email, number, comment, contributor_id, listed_date, type_id, age, tarif_id, juhe, version_id, fotocd) 
                           VALUES (:status_id, :customer_id, :datetime, :contact, :phone, :mobil, :email, :number, :comment, :contributor_id, :listed_date, :type_id, :age, :tarif_id, :juhe, :version_id, :fotocd);");
    ...
    $data = array(  'status_id' => '1', 'customer_id' => '1', 'datetime' => '2013-09-12 10:15:00','contact' => 'Fr. Schäfer','phone' => '','mobil' => '','email' => '','number' => '31','comment' => '-','contributor_id' => '1','listed_date' => '2013-05-07','type_id' => '1','age' => '10. Klasse','tarif_id' => '1','juhe' => '','version_id' => '1','fotocd' => '1');
    $stmt->execute($data);
    $data = array(  'status_id' => '1', 'customer_id' => '2', 'datetime' => '2013-09-18 10:15:00','contact' => 'Fr. Lockum','phone' => '','mobil' => '','email' => '','number' => '33','comment' => '-','contributor_id' => '2','listed_date' => '2013-05-06','type_id' => '1','age' => '8. Klasse','tarif_id' => '2','juhe' => '1','version_id' => '2','fotocd' => '1');
    $stmt->execute($data);
    ...
    $stmt->execute($data);
    $data = array(  'status_id' => '1','customer_id' => '1', 'datetime' => '2013-08-20 10:15:00','contact' => 'Hr. Meier','phone' => '','mobil' => '','email' => '','number' => '12','comment' => '-','contributor_id' => '1','listed_date' => '2013-04-17','type_id' => '1','age' => '12-14 Jahre','tarif_id' => '1','juhe' => '','version_id' => '1','fotocd' => '');
    $stmt->execute($data);
    ...
    $DBH->exec("INSERT INTO customer (organisation, street, postcode, city, phone, mobil, email, listed_since, contributor_id) 
                           VALUES ('Eschbachgymnasium', 'Hauptstr. 3', '63545', 'Eschbach', '08711/6343321', '0171/2333322', 'eschbach@eschbach-e.de', '2013-01-23', '1');");
    $DBH->exec("INSERT INTO customer (organisation, street, postcode, city, phone, mobil, email, listed_since, contributor_id) 
